...
#   plot-vcfstats bcftools_stats_all.txt -P -p ./
#
# Edit as necessary and recreate the plots by running
#   python plot.py
#
# Title abbreviations:
# 	 0 .. autos .. autosomal_sexual.vcf
#
...
if plot_SNP_count_by_af:
	...
	if 0 in dat and len(dat[0])>2:
		ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='autos')
		has_data = 1
